    ...
    _renderDefaultAuthView() {
        this.dom.authContainer.innerHTML = `
            <div class="flex items-center gap-4">
                ...
                <a href="#" data-auth-action="show_email_login" class="text-sm text-slate-400 hover:text-white whitespace-nowrap">התחברות עם אימייל </a>
            </div>
        `;
    }
        ...
        try {
            ...
            if (version) {
                ...
                if (titleElement) {
                    ...
                    versionElement.className = 'text-xs text-slate-500 mb-1 -mt-3.5';
