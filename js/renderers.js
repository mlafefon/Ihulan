        ...
        <div class="custom-color-picker ${customClass}" data-property="${prop}" data-value="${displayValue}">
            ...
            <div class="color-popover hidden">
                ...
                <div class="flex gap-2 pt-3 mt-3 border-t border-slate-700">
                    <button data-action="cancel-color" class="sidebar-btn bg-slate-600 hover:bg-slate-500 text-xs flex-1">ביטול</button>
                    <button data-action="confirm-color" class="sidebar-btn bg-green-600 hover:bg-green-700 text-xs flex-1">אישור</button>
                </div>
            </div>
        </div>
    </div>`;
